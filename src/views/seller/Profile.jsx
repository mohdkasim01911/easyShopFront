                        ...
                        <div className='px-0 md:px-5 py-2'>
                            {
                                !userInfo?.shopInfo ? <form onSubmit={add}>
                                    ...
                                    <div className='flex flex-col w-full gap-1 mb-2'>
                                        ...
                                        <input value={state.sub_district} onChange={inputHandle} className='px-4 py-2 focus:border-indigo-200 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='sub_district' id='subdis' placeholder='Sub District Name' />
                                    </div>
                                    ...
                                    <button disabled={loader ? true : false} className='bg-red-500 w-full hover:shadow-red-300/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>
                                        ...
                                        {
                                            loader ? <PropagateLoader color='#fff' cssOverride={overrideStyle} /> : 'Save Change'
                                        }
