...
const SellerDashboard = () => {
  ...
  const state = {
    series: [
      {
        name: "Orders",
        data: [23, 34, 45, 56, 76, 34, 28, 76, 87, 78, 34, 45]
      },
      {
        name: "Revenue",
        data: [67, 39, 45, 56, 90, 56, 20, 56, 87, 78, 67, 78]
      },
      {
        name: "Sellers",
        data: [34, 39, 56, 56, 80, 67, 32, 56, 98, 78, 45, 56]
      },
    ],
    options: {
      color: ['#181ee8', '#181ee8'],
      ...
      responsive: [
        {
          breakpoint: 565,
          yaxis: {
            categoreis: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
          },
          options: {
            plotOptions: {
              bar: {
